...
const CONCLUSIONS={
  '1':[
    ...
    {text:'La Falla Palu-Koro (PKF) constituye el principal límite cinemático intra-isla con desplazamiento sinestral activo, conectando el NST al norte con la Falla Matano al sur en un punto triple.',ref:'Socquet et al. (2006); Walpersdorf et al. (1998)'},
    ...
    {text:'La doble subducción opuesta en el Mar de Molucas (Sangihe buzante al oeste + Halmahera buzante al este) es única a escala global y genera el Complejo de Colisión del Mar de Molucas como producto activo de acreción entre ambos arcos.',ref:'Yuan et al. (2024); Hall & Spakman (2015)'},
  ],
  '2':[
    {text:'El sismo de Palu 2018 fue un evento de supercizalla multisegmento sobre la PKF, con propagación hacia el sur a velocidad superior a la de la onda S, documentando la primera ruptura de supercizalla confirmada en una falla continental sinestral activa.',ref:'Natawidjaja, D. H. et al. (2021)'},
    {text:'La brecha sísmica central del NST no ha producido sismos interplaca significativos. Tres hipótesis compiten: bajo acoplamiento, deslizamiento asísmico, o acumulación de estrés para un futuro gran sismo.',ref:'Serhalawan & Chen (2024)'},
    ...
    {text:'El Cabalgamiento Batui exhibe actividad confirmada por morfometría tectónica, directamente ligada al frente de avance del microcontinente Banggai-Sula sobre la plataforma de Sulawesi.',ref:'Hikmy & Isbram (2025)'},
  ],
  '3':[
    {text:'La tomografía global y regional confirma múltiples losas activas bajo Sulawesi y sus mares adyacentes: Sangihe (buzante al oeste, Mar de Célebes), Halmahera (buzante al este), Banda (rollback desde el Mioceno Medio) y Sula (buzante al norte, posiblemente remanente pre-Mioceno).',ref:'Kesumastuti et al. (2025); Hall & Spakman (2015)'},
    {text:'La anomalía de baja Vp bajo el brazo este se interpreta como delaminación litosférica post-colisión Banggai-Sula o como ventana mantélica por desprendimiento de la losa — el remanente de litósfera pierde su tracción de losa y deja una ventana por donde asciende manto caliente, coherente con la secuencia cinemática de la losa Sula.',ref:'Kesumastuti et al. (2025); Hall & Spakman (2015)'},
    {text:'Los vectores de eje rápido SKS en Sulawesi y el Mar de Molucas revelan flujo mantélico toroidal alrededor de los bordes de las losas, con extrusión lateral en la cuña mantélica de Banda — patrón sin análogo conocido en otros sistemas de subducción.',ref:'Di Leo et al. (2012); Hua et al. (2023); Yuan et al. (2024)'},
    {text:'El espesor cortical varía significativamente entre el Mar de Célebes (litosfera oceánica delgada) y el norte de Sulawesi (corteza continental engrosada), con la PKF actuando como límite abrupto en su segmento marino.',ref:'Yang et al. (2026)'},
  ],
  '4':[
    {text:'La anomalía de Bouguer negativa sobre el brazo sur–central indica déficit de densidad en profundidad — raíz cortical compensada isostáticamente por Airy bajo la Provincia Ígnea de Sulawesi Oeste y el arco Eoceno-Oligoceno. La anomalía de Bouguer positiva sobre el Mar de Célebes indica litosfera oceánica delgada y joven (sin raíz).',ref:'Bonvalot et al. (2012); Shih et al. (2026)'},
  ...
  '6':[
    {text:'El campo de velocidades GPS muestra partición de la deformación en bloques discretos: el brazo norte se desplaza hacia el SE mientras el sistema PKF-Matano absorbe la componente sinestral de la convergencia oblicua.',ref:'Socquet et al. (2006); Walpersdorf et al. (1998)'},
    {text:'La PKF exhibe una segmentación geomorfológica en cuatro sectores (Tanimbaya, Donggala, Palu, Saluki), con la ruptura de 2018 documentando que múltiples segmentos pueden activarse en un único evento de supercizalla.',ref:'Natawidjaja, D. H. et al. (2021)'},
  ],
  '7':[
    {text:'La Ofiolita de Sulawesi Este (ESO) es litósfera oceánica del Cretácico Temprano obductada sobre el microcontinente Banggai-Sula durante el Neógeno tardío. Su presencia define el brazo este como un terreno fundamentalmente oceánico.',ref:'Husein et al. (2014); Faturrakhman et al. (2024)'},
    {text:'Los dos sistemas de arco de Sulawesi son de tipo distinto: el Arco Volcánico del Brazo Norte es un arco de islas (subducción océano-océano del Mar de Célebes), mientras la Provincia Ígnea de Sulawesi Oeste es magmatismo de arco continental sobre corteza engrosada. Documentan episodios separados en tiempo y espacio, reflejando la migración del frente subductante.',ref:'Baillie & Decker (2022); Satyana et al. (2011)'},
    {text:'El Complejo de Colisión del Mar de Molucas (MSCC) entre los arcos Sangihe y Halmahera es un ejemplo activo de acreción por colisión de arcos, con material ofiolítico y pelágico deformado entre dos sistemas de subducción opuestos.',ref:'Yuan et al. (2024)'},
    ...
    {text:'La secuencia metamórfica registra la acreción progresiva de bloques continentales y oceánicos sobre el núcleo de Sulawesi: el CSMB (Esquistos de Pompangeo + mezcla tectónica) se forma como complejo de acreción Cretácico-Paleógeno, y los metamorphic core complexes (PMC, MMC) se exhuman en el Mioceno-Plioceno por extensión ligada al rollback del Mar de Célebes.',ref:'Baillie & Decker (2022)'},
  ],
  'general':[
    ...
    {text:'La deformación activa muestra partición de la deformación en bloques discretos por un sistema de fallas de primer orden: PKF (sinestral), Matano (dextral, E-W), Sorong (dextral) y NST (megacabalgamiento). La partición varía por segmento: el NST presenta al menos una brecha sísmica sin ruptura histórica significativa, mientras la PKF demostró en 2018 que puede romper múltiples segmentos en un evento de supercizalla único.',ref:'Jibran & Rafie (2025); Serhalawan & Chen (2024); Natawidjaja et al. (2021)'},
    {text:'El sistema mantélico bajo Sulawesi es uno de los más complejos globalmente: múltiples losas activas (Sangihe, Halmahera, Banda, Sula) con geometrías y edades distintas, flujo toroidal alrededor de los bordes de las losas, y la doble subducción opuesta del Mar de Molucas como estructura geotectónica sin análogo conocido en el planeta.',ref:'Yuan et al. (2024); Kesumastuti et al. (2025); Di Leo et al. (2012); Hall & Spakman (2015)'},
    {text:'La amenaza sísmica, el potencial geotérmico y las manifestaciones de H₂ natural son consecuencia directa de la geodinámica activa y no pueden interpretarse sin ella: el sismo de Palu 2018 (supercizalla), los campos de Lahendong-Tompaso y la emisión de Tanjung Api son expresiones en superficie de procesos mantélicos y corticales que este mapa documenta en sus siete secciones.',ref:'Natawidjaja et al. (2021); Pratama et al. (2025); Faturrakhman et al. (2025)'},
  ],
};
