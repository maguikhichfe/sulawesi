...
const CONCLUSIONS={
  '1':[
    {text:'Sulawesi ocupa la intersección de tres sistemas de placas mayores: la Indo-Australiana, la de Filipinas/Pacífico y la Euroasiática/Sunda, generando la morfología de "orquídea" de cuatro brazos como resultado de múltiples colisiones desde el Oligoceno.',ref:'Socquet et al. (2006); Baillie & Decker (2022)'},
  ...
  '4':[
    {text:'La anomalía de Bouguer negativa sobre el brazo sur–central refleja corteza continental engrosada de la West Sulawesi Igneous Province y el arco Eoceno-Oligoceno, mientras la anomalía positiva sobre el Mar de Célebes indica litosfera oceánica delgada y joven.',ref:'Bonvalot et al. (2012); Shih et al. (2026)'},
    ...
    {text:'La anomalía de Free-air positiva sobre el arco volcánico del brazo norte y la anomalía negativa en la cuenca trasarco son coherentes con el modelo de subducción activa del NST.',ref:'Bonvalot et al. (2012)'},
  ],
  '5':[
  ...
  '6':[
    {text:'El campo de velocidades GPS muestra que la deformación de Sulawesi está particionada en bloques discretos: el brazo norte se desplaza hacia el SE mientras el sistema PKF-Matano absorbe la componente sinestral de la convergencia.',ref:'Socquet et al. (2006); Walpersdorf et al. (1998)'},
    ...
    {text:'El West Sulawesi Fold Belt (WSFB) y el North Sulawesi Fold-Thrust Belt (NSFTB) representan los frentes de deformación compresiva asociados al avance del bloque Sulawesi sobre la plataforma de Sunda al oeste y al norte respectivamente.',ref:'Serhalawan & Chen (2024); Baillie & Decker (2022)'},
  ],
  '7':[
    ...
    {text:'La West Sulawesi Igneous Province (WSIP) y el North Arm Volcanic Arc documentan dos episodios de magmatismo de arco separados en tiempo y espacio, reflejando la migración del frente subductante.',ref:'Baillie & Decker (2022); Satyana et al. (2011)'},
    ...
    {text:'El Complejo Bantimala (SW Sulawesi) contiene el único registro UHP confirmado de la región indonesia: eclogitas con coesite que documentan subducción continental profunda durante el Cretácico Temprano.',ref:'Parkinson et al. (1998); Böhnke et al. (2024)'},
    {text:'El espectro metamórfico de Sulawesi cubre desde UHP-eclogita (Bantimala, SW) hasta blueschist HP (Mekongga-Rumbia, SE), anfibolita (PMC, central) y esquisto verde (CSMB; MMC), registrando al menos tres episodios de subducción distintos.',ref:'Baillie & Decker (2022); Böhnke et al. (2024)'},
    {text:'La secuencia temporal del metamorfismo — Cretácico UHP, Mioceno HP — refleja la progresiva acreción de bloques continentales y oceánicos sobre el núcleo de Sulawesi, con cada evento metamórfico marcando una colisión o inicio de subducción.',ref:'Parkinson et al. (1998); Advokaat et al. (2017)'},
  ],
  'general':[
    ...
    {text:'El ensamblaje de Sulawesi involucra al menos tres episodios tectónicos distintos registrados estratigráfica y metamórficamente: subducción profunda del Cretácico Temprano (Bantimala UHP), inicio de subducción del NST en el Mioceno Tardío y colisión del microcontinente Banggai-Sula en el Plioceno. Cada episodio deja una firma en el registro metamórfico, geoquímico y cinemático de la isla.',ref:'Parkinson et al. (1998); Satyana et al. (2011); Kesumastuti et al. (2025)'},
    {text:'La deformación activa está particionada en bloques discretos por un sistema de fallas de primer orden: PKF (sinestral), Matano (dextral, E-W), Sorong (dextral) y NST (megathrust). La partición varía por segmento: el NST presenta al menos un gap sísmico sin ruptura histórica significativa, mientras la PKF demostró en 2018 que puede romper múltiples segmentos en un evento supershear único.',ref:'Jibran & Rafie (2025); Serhalawan & Chen (2024); Natawidjaja et al. (2021)'},
